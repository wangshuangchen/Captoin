...
model_checkpoint = "/home3/wangshuangchen/model/InternVL3_5-8B-HF"
processor = AutoProcessor.from_pretrained(model_checkpoint)
model = AutoModelForImageTextToText.from_pretrained(model_checkpoint, device_map=torch_device, torch_dtype=torch.bfloat16)

# lora微调时打开
model = PeftModel.from_pretrained(model, "/home3/wangshuangchen/LLaMA-Factory-main/saves/InternVL3_5-8B-HF-Multimodal-dianwang_cot/lora/sft")
...
def main():
    ...
    output_file = "/home3/wangshuangchen/LLaMA-Factory-main/results_lora/InternVL3_5-8B-test-1642.jsonl"    # Output file in JSON Lines format
