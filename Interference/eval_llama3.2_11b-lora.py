...
model_path = "/root/autodl-tmp/Llama-3.2-11B-Vision-Instruct"
...
model = PeftModel.from_pretrained(
    model, 
    "/root/LLaMA-Factory-main/saves/Llama-3.2-11B-Vision-Instruct-12346-6000/lora/sft"
)
...
def main(batch_size = 8):
    ...
    output_file = "/root/LLaMA-Factory-main/results-1642/Llama-3.2-11B-lora-Vision-Instruct-test-1642.jsonl"
    os.makedirs(os.path.dirname(output_file), exist_ok=True)
    image_dir = "/root/images/images_cot2"
...
if __name__ == "__main__":
    main(26)  # Set batch size to 32, adjust based on GPU memory 