...
model = PeftModel.from_pretrained(
    model, 
    "/root/LLaMA-Factory-main/saves/Qwen2.5-VL-3B-Instruct-12346-6000/lora/sft"
)
...
def batch_predict(batch_image_paths, batch_questions, model, processor, tokenizer):
    ...
    try:
        ...
        generated_ids = model.generate(
            **inputs,
            max_new_tokens=1024,  # 减少生成长度以降低显存压力
            temperature=0.7,
            top_p=0.9,
            do_sample=True,
...
def main(batch_size = 8):
    ...
    output_file = "/root/LLaMA-Factory-main/results-1642/Qwen2.5-VL-3B-lora-6000-test-1642.jsonl"  # Modify to your fine-tuned model's output file path
