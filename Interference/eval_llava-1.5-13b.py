...
base_model_path = "/root/autodl-tmp/llava-1.5-13b-hf"
...
# lora微调打开
# model = PeftModel.from_pretrained(model, "/root/LLaMA-Factory-main/saves/llava-1.5-13b-hf-12346-6000/lora/sft")
